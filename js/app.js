...
const resources = [
    ...
    { id: 2, name: "Ollama", description: "Get up and running with large language models.", downloadLink: "/detail.html?key=ollama", officialLink: "https://ollama.com/", iconLink: "https://ollama.com/public/ollama.png" },
    { id: 3, name: "EncryptSynaptics", description: "针对于Synaptics蠕虫的杀毒工具", downloadLink: "/detail.html?key=encrypt-synaptics", officialLink: "/ruanjian/null.html", iconLink: "" },
    { id: 4, name: "Clash Verge", description: "基于 Tauri 的现代 GUI 客户端，以提供...", downloadLink: "/detail.html?key=clash-verge", officialLink: "https://clashcn.com/clash-verge", iconLink: "https://clashcn.com/wp-content/uploads/2023/11/clashverge-300x300-1.png" },
];
